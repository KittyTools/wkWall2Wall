...
Config Config::load(const std::string& gameDirectory) {
    ...
    config.hookProbeOnly = GetPrivateProfileIntA("Hooks", "ProbeOnly", 0, iniPath.c_str()) != 0;
    ...
    config.enableRendererApiProbe = GetPrivateProfileIntA("Hooks", "EnableRendererApiProbe", 1, iniPath.c_str()) != 0;
    config.enableCameraProbe = GetPrivateProfileIntA("Hooks", "EnableCameraProbe", 1, iniPath.c_str()) != 0;
    config.enableDirect3D9Probe = GetPrivateProfileIntA("Hooks", "EnableDirect3D9Probe", 1, iniPath.c_str()) != 0;
    config.enableDirect3D9DeviceSlotProbe = GetPrivateProfileIntA("Hooks", "EnableDirect3D9DeviceSlotProbe", 1, iniPath.c_str()) != 0;
    config.enableDirect3D9OverlaySmokeTest = GetPrivateProfileIntA("Hooks", "EnableDirect3D9OverlaySmokeTest", 0, iniPath.c_str()) != 0;
    config.enableDirect3D9MetadataOverlayTest = GetPrivateProfileIntA("Hooks", "EnableDirect3D9MetadataOverlayTest", 1, iniPath.c_str()) != 0;
    ...
    config.enableDirect3D9MetadataOverlayAutoViewportX = GetPrivateProfileIntA("Hooks", "EnableDirect3D9MetadataOverlayAutoViewportX", 1, iniPath.c_str()) != 0;
    config.enableDirect3D9MetadataOverlayAutoViewportY = GetPrivateProfileIntA("Hooks", "EnableDirect3D9MetadataOverlayAutoViewportY", 1, iniPath.c_str()) != 0;
    config.enableDirect3D9MetadataOverlayCameraFollow = GetPrivateProfileIntA("Hooks", "EnableDirect3D9MetadataOverlayCameraFollow", 1, iniPath.c_str()) != 0;
    config.direct3D9MetadataOverlayCameraSlot = GetPrivateProfileIntA("Hooks", "Direct3D9MetadataOverlayCameraSlot", 4, iniPath.c_str());
    ...
    config.wallTouchedSoundPaths[0] = readPathValue(iniPath, gameDirectory, "Sounds", "WallTouched1", "User\\Speech\\wall_touch_1.wav");
    config.wallTouchedSoundPaths[1] = readPathValue(iniPath, gameDirectory, "Sounds", "WallTouched2", "User\\Speech\\wall_touch_2.wav");
    config.wallTouchedSoundPaths[2] = readPathValue(iniPath, gameDirectory, "Sounds", "WallTouched3", "User\\Speech\\wall_touch_3.wav");
    config.wallTouchedSoundPaths[3] = readPathValue(iniPath, gameDirectory, "Sounds", "WallTouched4", "User\\Speech\\wall_touch_4.wav");
    config.wallTouchedSoundPaths[4] = readPathValue(iniPath, gameDirectory, "Sounds", "WallTouched5", "User\\Speech\\wall_touch_5.wav");
    config.wallTouchedExtraSoundPath = readPathValue(iniPath, gameDirectory, "Sounds", "WallTouchedX", "User\\Speech\\wall_touch_x.wav");
    config.allWallsTouchedSoundPath = readPathValue(iniPath, gameDirectory, "Sounds", "AllWallsTouched", "User\\Speech\\all_walls_touched.wav");
    config.warningWallsSoundPath = readPathValue(iniPath, gameDirectory, "Sounds", "WarningWalls", "User\\Speech\\warning_walls.wav");
    config.warningCrateSoundPath = readPathValue(iniPath, gameDirectory, "Sounds", "WarningCrate", "User\\Speech\\warning_crate.wav");
    config.warningRopeSoundPath = readPathValue(iniPath, gameDirectory, "Sounds", "WarningRope", "User\\Speech\\warning_afr.wav");
